<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="OnlineJobSearchPortal.WebForm2"unobtrusivevalidationmode="none"%>
    ...
    <form id="form1" runat="server">
      ...
      <p class="point">&#9650;</p>
            ...
            <asp:TextBox ID="TextBox1" class="LoTextBox" runat="server"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*Username is Required Field " ControlToValidate="TextBox1" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>            <br />
            <br />
...
&nbsp;<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="SIGN UP" CausesValidation="False" />
            <br />
            <br />
        </div>
        </div>
