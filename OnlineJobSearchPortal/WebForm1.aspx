<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="OnlineJobSearchPortal.WebForm1" %>
...
<body>
    <form id="form1" runat="server">
        <div class="start">
                ...
                <asp:Button ID="Button1" runat="server" ForeColor="White" Text="Login" OnClick="Button1_Click" />
                </div>
                <br />
                <br />
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-12 col-md-6">
            <h6>About</h6>
            <p class="text-justify">JobSearch.com <br />With JobSearch, you can search millions of jobs online to find the next step in your career. <br />With tools for job search, resumes, company reviews and more, ...</p>
          </div>
